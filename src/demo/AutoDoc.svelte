...
<script>
  ...
  // Installation docs
  const installDocs = `$ yarn add https://github.com/reuters-graphics/chart-module-vaccination-cumulative.git`;

  // JavaScript docs
  $: jsDocs = `import Chart from '@reuters-graphics/vaccination-cumulative';
...
`;
  ...
  // SCSS docs
  const styleDocs = `$CountryVaccination-container: '.vaccination-cumulative-container';

@import '~@reuters-graphics/vaccination-cumulative/src/scss/chart';`;
...
<div class='repo-link'>
  <a href="https://github.com/reuters-graphics/chart-module-vaccination-cumulative" target="_blank">
    <Icon icon={faGithub} />
  </a>
</div>
